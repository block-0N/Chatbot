...
"!GXX!" -std=c++17 -O2 -finput-charset=UTF-8 -fexec-charset=UTF-8 src\functions.cpp !RES_ARG! -o release\functions.exe
if errorlevel 1 (
    echo [错误] 失败。
    pause
    exit /b 1
...
"!GXX!" -std=c++17 -O2 -finput-charset=UTF-8 -fexec-charset=UTF-8 src\dict.cpp !RES_ARG! -o release\dict.exe
if errorlevel 1 (
    echo [错误] 失败。
    pause
    exit /b 1
